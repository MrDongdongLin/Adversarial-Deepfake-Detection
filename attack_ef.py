...
def main():
    ...
    model = MyEfficientNet(num_classes=2, pretrained=False)
...
if __name__ == '__main__':
    ...
    parse.add_argument('--model_path', '-mp', type=str,
                       default='D:\\Deepfake\\Methods\\Deepfake-Detection-master\\outputs\\ef_celebdfv2\\best.pt')
    parse.add_argument('--path_to_save', type=str, default='D:\\Deepfake\\Datasets\\Celeb-DF-v2\\images\\attacks\\ef')
