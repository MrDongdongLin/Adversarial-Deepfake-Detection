...
from network.efficientnet import MyEfficientNet
...
def main():
    ...
    writer = SummaryWriter(comment='EF')
    ...
    model = MyEfficientNet(num_classes=2, pretrained=True)
    if continue_train:
