...
def main():
    ...
    model = Xception_lstm(pretrained=False, nc=2)
...
if __name__ == '__main__':
    ...
    parse.add_argument('--model_path', '-mp', type=str,
                       default='D:\\Deepfake\\Methods\\Deepfake-Detection-master\\outputs\\xl_celebdfv2\\best.pt')
    parse.add_argument('--path_to_save', type=str, default='D:\\Deepfake\\Datasets\\Celeb-DF-v2\\images\\attacks\\xl')
